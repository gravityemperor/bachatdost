	...
	class CR_Shortcodes_Settings {
		...
		*/
		...
		public function show_shortcodes( $value ) {
			...
			'show_products="true" categories="" product_tags="" products="" shop_reviews="true" number_shop_reviews="-1" inactive_products="false" show_replies="false" show_more="0" min_chars="0" avatars="initials"]</code></p>' .
